...
\begin{frame}
	...
	\centering
		\begin{tabular}{c|c|c|l}
			...
			1& 3& $\frac{1}{6}(x_1^3+2x_3^1+3x_1^1 x_2^1)$ & triangle \\\hline
			2 & 6 & $\frac{1}{6}(x_1^6+2x_3^2+3x_1^2x_2^2)$ & 			\includegraphics[width=2cm]{newtriangle_copya}\\\hline
			3 & 9 & $\frac{1}{6}(x_1^9+2x_3^3+3x_1^1x_2^4)$ & \includegraphics[width=2cm]{newtriangle_copy9}\\\hline
			4 & 12 & $\frac{1}{6}(x_1^{12}+2x_3^4+3x_1^2x_2^5)$ & \includegraphics[width=2cm]{newtriangle_copy12}\\\hline
		\end{tabular}
	\end{table}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Understanding the Different Cases Concerning Flips}
	This is a hexagon inscribed inside a triangle:\\
		...
		$\frac{1}{6}(x_1^6+2x_3^2+3x_1^2x_2^2)$\\
	But so is this:\\
		\includegraphics[width=3cm]{newtriangle_copy1}
		$\frac{1}{6}(x_1^6+2x_3^2+ 3x_2^3)$\\
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
...
\begin{frame}
Recall:\\
	\begin{tcolorbox}[colback=yellow!10!white,colframe=blue!75!black,title=The Euler Phi Function]
    	\begin{center}
...
\begin{frame}
    \begin{tcolorbox}[colback=yellow!10!white,colframe=red!75!black,title=Theorem:Rotation Monomials]
    	The monomials for $C_k\circlearrowright nk$-gon:\\
    	\begin{center}
